...
const Sidebar = ({ className, lastUpdate }) => {
    ...
    return (
        <>
            <aside {...handlers} className={`sidebar ${className} ${toggle && '!left-0'} max-h-[100dvh] min-h-[100dvh] scrollbar-hide overflow-x-auto fixed -left-64 lg:left-0 top-0 bg-container border border-stroke pl-0 p-6 w-64 flex flex-col gap-8 justify-between text-center transition-3s z-10 sm:z-0 shadow-sm`}>
